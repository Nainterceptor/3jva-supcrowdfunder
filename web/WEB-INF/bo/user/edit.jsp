...
<div class="container">
    ...
    <div class="row">
        <form role="form" action="<c:out value="${originURL}" />" method="post">
            ...
            <div class="form-group <c:if test="${result != null}">${empty errors['admin'] ? 'has-success' : 'has-error'}</c:if>">
                <label class="control-label" for="admin"><fmt:message key="db.user.admin" /></label>
                <input type="checkbox"
                       id="admin"
                       name="admin"
                       value="true"
                       ...
                       >
                <c:if test="${errors['admin'] != null}">
                    <span class="help-block"><fmt:message key="${errors['admin']}" /></span>
                </c:if>
            </div>
